...
# Неделя, которая начинается в ПН 12.01.2026 – це ЧИСЕЛЬНИК
...
def create_schedule_bcig():
    """БЦІГ-25 - первое фото (с разделением на числитель/знаменатель ТОЛЬКО где они разные)"""
    return {
        "monday": {
            "чисельник": {
                ...
                "6": {"subject": "немає пари", "room": "", "teacher": ""}
            },
            "знаменник": {
                "1": {"subject": "Фізика і астрономія", "room": "129", "teacher": "Гуленко І.А."},
                "2": {"subject": "Українська література", "room": "115", "teacher": "Лосєва К.С."},
...
def create_schedule_bcis():
    """БЦІСТ-25 (включая ТЕ-25) - второе фото (с разделением на числитель/знаменатель ТОЛЬКО где они разные)"""
    return {
        "monday": {
            "чисельник": {
                "1": {"subject": "Фізична культура", "room": "с/з №2", "teacher": "Свиридов А.П."},
                "2": {"subject": "Іноземна мова", "room": "224 а", "teacher": "Криваночеченкова Л.І."},
                "3": {"subject": "Математика", "room": "121", "teacher": "Приймак О.В."},
                "4": {"subject": "Організаційна година", "room": "205", "teacher": "Крамаренко Л.О."},
                "5": {"subject": "Випорядник", "room": "", "teacher": ""}
            },
            "знаменник": {
                "1": {"subject": "Фізична культура", "room": "с/з №2", "teacher": "Свиридов А.П."},
                "2": {"subject": "Іноземна мова", "room": "224 а", "teacher": "Криваночеченкова Л.І."},
        ...
        "tuesday": {
            "чисельник": {
                ...
                "4": {"subject": "Інформатика", "room": "39", "teacher": "Короленко / Єреи"}
            },
            "знаменник": {
                "1": {"subject": "Біологія і екологія", "room": "16", "teacher": "Золотова К.В."},
                "2": {"subject": "Всесвітня історія", "room": "114", "teacher": "Меленчук Ю.Д."},
                "3": {"subject": "Інформатика", "room": "39", "teacher": "Короленко / Єреи"},
                "4": {"subject": "немає пари", "room": "", "teacher": ""}
            }
        },
        "wednesday": {
...
def get_day_struct(d, user_id=None):
    if user_id:
        ...
        user_schedule = schedule.get("БЦІГ-25")  # По умолчанию
...
def choose_group_callback(call):
    group = call.data.split("_")[2]  # choose_group_БЦІГ-25
