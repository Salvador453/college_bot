...
def _kyiv_utc_offset_hours(utc_dt):
    """Україна: літній час (UTC+3) з останньої неділі березня по останню неділю жовтня, інакше UTC+2."""
    year = utc_dt.year
    dst_start = datetime.combine(_last_sunday(year, 3), datetime.min.time()) + timedelta(hours=1)  # 01:00 UTC
    dst_end = datetime.combine(_last_sunday(year, 10), datetime.min.time()) + timedelta(hours=1)    # 01:00 UTC
    return 3 if dst_start <= utc_dt < dst_end else 2

def now_kyiv():
    """Поточний час у Києві з урахуванням переходу на літній/зимовий час."""
    utc_now = datetime.utcnow()
    return utc_now + timedelta(hours=_kyiv_utc_offset_hours(utc_now))
...
REFERENCE_MONDAY = date(2026, 9, 7)
...
def create_schedule_bcig():
    return {
        "monday": {
            "чисельник": {
                "1": {"subject": "Фізична культура",   "room": "с/з №2", "teacher": "Деркач С.В."},
                "2": {"subject": "Українська мова с.к.","room": "307",   "teacher": "Гавриленко С.Т."},
                "3": {"subject": "Захист України",     "room": "201",   "teacher": "Красільніков Є.Б."},
                "org": {"subject": "Організаційна година","room": "205", "teacher": "Крамаренко Л.О."},
                "4": {"subject": "Математика с.к.",    "room": "121",   "teacher": "Приймак О.В."},
                "5": {"subject": "Історія України с.к.","room": "",      "teacher": ""},
            },
            "знаменник": {
                "1": {"subject": "Фізична культура",   "room": "с/з №2", "teacher": "Деркач С.В."},
                "2": {"subject": "Українська мова с.к.","room": "307",   "teacher": "Гавриленко С.Т."},
                "3": {"subject": "Інформатика",        "room": "239",   "teacher": "Короленко Г.І."},
                "org": {"subject": "Організаційна година","room": "205", "teacher": "Крамаренко Л.О."},
                "4": {"subject": "Математика с.к.",    "room": "121",   "teacher": "Приймак О.В."},
                "5": {"subject": "Історія України с.к.","room": "",      "teacher": ""},
            },
        ...
        "tuesday": {
            "чисельник": {
                ...
                "3": {"subject": "Інженерна геодезія",  "room": "204", "teacher": "Філімонова І.А."},
                "4": {"subject": "Математика",         "room": "121", "teacher": "Приймак О.В."},
            },
            "знаменник": {
                "2": {"subject": "Українська мова",    "room": "307", "teacher": "Гавриленко С.Т."},
                "3": {"subject": "Інженерна геодезія",  "room": "204", "teacher": "Філімонова І.А."},
        ...
        "wednesday": {
            "чисельник": {
                ...
                "2": {"subject": "Гідравліка",           "room": "201", "teacher": "Черненко А.В."},
                "3": {"subject": "Українська література","room": "119", "teacher": "Топач А.А."},
                "4": {"subject": "Біологія і екологія",  "room": "16",  "teacher": "Золотова К.В."},
                "5": {"subject": "Географія с.к.",       "room": "",    "teacher": ""},
            },
            "знаменник": {
                "1": {"subject": "Фізика і астрономія", "room": "129", "teacher": "Гуленко І.А."},
                "2": {"subject": "Гідравліка",           "room": "201", "teacher": "Черненко А.В."},
        ...
        "thursday": {
            "чисельник": {
                ...
                "2": {"subject": "Математика с.к.",     "room": "121",   "teacher": "Приймак О.В."},
                "3": {"subject": "Гідрологія та гідрометрія", "room": "231", "teacher": "Щепіна Н.В."},
                "4": {"subject": "Іноземна мова",       "room": "224 а", "teacher": "Кривандеченкова Л.І."},
            },
            "знаменник": {
                "1": {"subject": "Технології",          "room": "308",   "teacher": "Лисечко В.М."},
                "2": {"subject": "Українська мова с.к.","room": "307",   "teacher": "Гавриленко С.Т."},
                "3": {"subject": "Гідрологія та гідрометрія", "room": "231", "teacher": "Щепіна Н.В."},
                "4": {"subject": "Іноземна мова",       "room": "224 а", "teacher": "Кривандеченкова Л.І."},
            },
        ...
        "friday": {
            "чисельник": {
                "1": {"subject": "Фізична культура",   "room": "с/з №2", "teacher": "Деркач С.В."},
                "2": {"subject": "Будівельне матеріалознавство", "room": "205", "teacher": "Крамаренко Л.О."},
                "3": {"subject": "Фізика і астрономія","room": "129", "teacher": "Гуленко І.А."},
                "4": {"subject": "Хімія",              "room": "16",  "teacher": "Золотова К.В."},
            },
            "знаменник": {
                "1": {"subject": "Зарубіжна література","room": "116", "teacher": "Мещерякова О.В."},
                "2": {"subject": "Будівельне матеріалознавство", "room": "205", "teacher": "Крамаренко Л.О."},
                "3": {"subject": "Історія України",     "room": "114", "teacher": "Мелещук Ю.Д."},
...
def create_schedule_bcis():
    return {
        "monday": {
            "чисельник": {
                "1": {"subject": "Українська мова с.к.","room": "307",  "teacher": "Гавриленко С.Т."},
                "2": {"subject": "Фізична культура",    "room": "с/з №2","teacher": "Деркач С.В."},
                "3": {"subject": "Математика с.к.",     "room": "121",  "teacher": "Приймак О.В."},
                "org": {"subject": "Організаційна година","room": "307", "teacher": "Гавриленко С.Т."},
                "4": {"subject": "Економічна теорія",   "room": "145",  "teacher": "Усова С.В."},
                "5": {"subject": "Історія України с.к.","room": "",      "teacher": ""},
            },
            "знаменник": {
                "1": {"subject": "Українська мова с.к.","room": "307",  "teacher": "Гавриленко С.Т."},
                ...
                "3": {"subject": "Математика с.к.",     "room": "121",  "teacher": "Приймак О.В."},
                "org": {"subject": "Організаційна година","room": "307", "teacher": "Гавриленко С.Т."},
                "4": {"subject": "Технології",          "room": "207",  "teacher": "Ратнікова Л.І."},
                "5": {"subject": "Історія України с.к.","room": "",      "teacher": ""},
            },
        },
        "tuesday": {
            "чисельник": {
                "2": {"subject": "Українська література","room": "119", "teacher": "Топач А.А."},
                "3": {"subject": "Фізика і астрономія",  "room": "129", "teacher": "Гуленко І.А."},
                "4": {"subject": "Біологія і екологія",  "room": "16",  "teacher": "Золотова К.В."},
            },
            "знаменник": {
        ...
        "wednesday": {
            "чисельник": {
                "1": {"subject": "Українська мова",           "room": "307", "teacher": "Гавриленко С.Т."},
                "2": {"subject": "Математика",                "room": "121", "teacher": "Приймак О.В."},
                "3": {"subject": "Механіка рідини та газу",   "room": "27",  "teacher": "Дичок Г.М."},
                "4": {"subject": "БЖД",                       "room": "208", "teacher": "Потапова А.О."},
                "5": {"subject": "Географія с.к.",            "room": "",    "teacher": ""},
            },
            "знаменник": {
                "1": {"subject": "Українська мова",           "room": "307", "teacher": "Гавриленко С.Т."},
        ...
        "thursday": {
            "чисельник": {
                "1": {"subject": "Фізична культура",   "room": "с/з №2", "teacher": "Деркач С.В."},
                "2": {"subject": "Захист України",     "room": "201",    "teacher": "Красільніков Є.Б."},
                "3": {"subject": "Іноземна мова",      "room": "224 а",  "teacher": "Кривандеченкова Л.І."},
                "4": {"subject": "Інформатика",        "room": "27",     "teacher": "Дичок Г.М."},
            },
            "знаменник": {
                "1": {"subject": "Географія",          "room": "123",    "teacher": "Баранець Т.О."},
                "2": {"subject": "Всесвітня історія",  "room": "114",    "teacher": "Мелещук Ю.Д."},
                "3": {"subject": "Іноземна мова",      "room": "224 а",  "teacher": "Кривандеченкова Л.І."},
                "4": {"subject": "Механіка рідини та газу", "room": "27","teacher": "Дичок Г.М."},
            },
        },
        "friday": {
            "чисельник": {
            ...
            "знаменник": {
                "1": {"subject": "Математика с.к.",     "room": "121", "teacher": "Приймак О.В."},
                "2": {"subject": "Хімія",               "room": "224", "teacher": "Киящук Г.Л."},
                "3": {"subject": "Фізика і астрономія", "room": "129", "teacher": "Гуленко І.А."},
                "4": {"subject": "Економічна теорія",   "room": "145", "teacher": "Усова С.В."},
            },
        },
...
def load_meet_links():
    ...
    if not path_bcig.exists():
        bcig_links = {
            ...
            "Фізична культура": "https://meet.google.com/axc-rqft-ymf",
            "Хімія": "https://meet.google.com/qeq-rkjz-eny",
            "Математика": "https://meet.google.com/dyb-uuwd-ovf",
            "Математика с.к.": "https://meet.google.com/bra-cyho-ozm",
            "Захист України": "https://meet.google.com/iyg-ajzw-dgd",
            "Історія України с.к.": "https://meet.google.com/wna-wpaf-veq",
            "Географія с.к.": "https://meet.google.com/bib-whcx-kqu",
            "Гідравліка": "https://meet.google.com/yjx-awts-oku",
            "Технології": "https://meet.google.com/yxy-wizi-nhq",
            "Фізика і астрономія": "https://meet.google.com/srf-mxfn-byn",
            "Іноземна мова": "https://meet.google.com/mof-vjvt-wvp",
            "Географія": "https://meet.google.com/jdw-evfg-gvf",
            "Українська література": "https://meet.google.com/rkd-uend-qqd",
            "Всесвітня історія": "https://meet.google.com/ghb-zzbg-epu",
            "Інформатика": "https://meet.google.com/izp-vxvf-ohv",
            "Історія України": "https://meet.google.com/itr-tdwr-typ",
            "Інженерна геодезія": "https://meet.google.com/irn-sebu-cdy",
            "Українська мова с.к.": "https://meet.google.com/ygo-srry-qcq",
            "Українська мова": "https://meet.google.com/vgo-fkwg-iuc",
            "Гідрологія та гідрометрія": "https://meet.google.com/wcc-vzkp-awy",
            "Зарубіжна література": "https://meet.google.com/oow-bbvj-euk",
            "Біологія і екологія": "https://meet.google.com/bes-cdnr-bvc",
            "Будівельне матеріалознавство": "https://meet.google.com/qzq-xvcr-qae"
        }
    ...
    if not path_bcist.exists():
        bcist_links = {
            "Біологія і екологія": "https://meet.google.com/ggd-ohfi-xjn",
            "Зарубіжна література": "https://meet.google.com/fqc-rdqa-xtg",
            "Українська мова": "https://meet.google.com/xed-uoez-ixc",
            "Українська мова с.к.": "https://meet.google.com/ubc-cgvt-sfo",
            "Організаційна година": "https://meet.google.com/zki-ests-yth",
            "Технології": "https://meet.google.com/fxu-oywp-sev",
            "Історія України": "https://meet.google.com/fsj-fswe-rby",
            "Всесвітня історія": "https://meet.google.com/fke-etux-aso",
            "Українська література": "https://meet.google.com/ivk-gkod-bfj",
            "Економічна теорія": "https://meet.google.com/ykj-xizw-tdo",
            "Географія": "https://meet.google.com/brq-uvej-udg",
            "Інформатика": "https://meet.google.com/ebq-ppkf-erh",
            "Механіка рідини та газу": "https://meet.google.com/ych-bpvw-ntp",
            "Іноземна мова": "https://meet.google.com/hnt-fird-zhy",
            "Фізика і астрономія": "https://meet.google.com/gwv-nyrn-isz",
            "БЖД": "https://meet.google.com/uta-xfuz-jbt",
            "Захист України": "https://meet.google.com/yfj-namz-mfm",
            "Історія України с.к.": "https://meet.google.com/wna-wpaf-veq",
            "Географія с.к.": "https://meet.google.com/bib-whcx-kqu",
            "Математика с.к.": "https://meet.google.com/ahw-gtiw-jcr",
            "Математика": "https://meet.google.com/jdg-thry-tzj",
            "Хімія": "https://meet.google.com/gxq-fxvy-dtt",
            "Фізична культура": "https://meet.google.com/bps-jzsr-hgq"
        }
...
def setpair_cmd(message):
    ...
    temp_changes[group_name][day_key][week_type][str(pair_num)] = {
        ...
        "room": room,
        "teacher": teacher,
        "changed_at": (now_kyiv()).strftime("%Y-%m-%d %H:%M:%S"),
...
def check_airalarm_for_city():
    ...
    while True:
        try:
            ...
            airalarm_last_check = (now_kyiv()).strftime("%Y-%m-%d %H:%M:%S")
            active_now, raw = fetch_airalarm_city_status()
...
def send_pair_notification(pair_key, pair_num, pair, day_key, user_id):
    ...
    if "захист україни" in subj_norm:
        sapko_url = meet_links.get(group_name, {}).get("Захист України Сапко")
        kiyashchuk_url = meet_links.get(group_name, {}).get("Захист України Киящук")
        if sapko_url or kiyashchuk_url:
            markup = InlineKeyboardMarkup(row_width=1)
            if sapko_url:
                markup.add(InlineKeyboardButton(text=f"{pair_num}) {subj} — Сапко", url=sapko_url))
            if kiyashchuk_url:
            ...
            single_url = meet_links.get(group_name, {}).get("Захист України")
            if single_url:
                markup = InlineKeyboardMarkup()
                markup.add(InlineKeyboardButton(text="Увійти в Google Meet", url=single_url))
    else:
        url = get_meet_link_for_subject(subj, group_name)
        if url:
            markup = InlineKeyboardMarkup()
